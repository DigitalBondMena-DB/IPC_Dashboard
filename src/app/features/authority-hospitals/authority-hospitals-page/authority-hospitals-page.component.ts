...
@Component({
  selector: 'app-authority-hospitals-page',
  standalone: true,
...
export class AuthorityHospitalsPageComponent {
  ...
  readonly columns: ITableColumn[] = [
    ...
    { field: 'authority_name', header: 'Authority', sortable: true },
  ...
  onEdit(item: any): void {
    this.router.navigate(['/authorities-hospitals/edit', item.id]);
  }
  onCreate(): void {
    this.router.navigate(['/authorities-hospitals/create']);
  }
}
