...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, Accordion, AccordionPanel, AccordionHeader, AccordionContent, LucideAngularModule],
  templateUrl: './structure-preview.component.html',
  styles: [`
    /* Custom prime ng accordion styles to match design if needed */
